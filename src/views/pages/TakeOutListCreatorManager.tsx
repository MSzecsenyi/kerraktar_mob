...
import { LoginDrawerParamList, TakeOutStackParams } from "../../navigation/ParamStacks";
...
const TakeOutListCreatorManager = (navigationProps: TakeOutListCreatorManagerProps) => {
