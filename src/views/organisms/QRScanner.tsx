...
export default function QRScanner({
    ...
    const [scannedUniqueItem, setScannedUniqueItem] =
        useState<UniqueItem | null>(null);
    ...
    const acceptModal = () => {
        if (!guidInTakeOutList && scannedItem && scannedUniqueItem) {
            ...
            dispatchItems({
                ...
                payload: {
                    id: scannedItem.id,
                    uniqueId: scannedUniqueItem.unique_id,
                },
            });
    ...
    return (
        <View style={styles.container}>
            ...
            <DefaultModal visible={visible} closeFn={closeModal}>
                <View>
