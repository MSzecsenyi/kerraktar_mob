            ...
            <DefaultModal
                ...
                <>
                    <Text style={modalStyles.mainText}>
                        Biztosan törölni szeretnéd a listából az összes eddig
                        hozzáadott
                        <Text
                            style={
                                modalStyles.boldText
                            }>{` ${item.item_name}`}</Text>
                        -t?
                    </Text>
                    <Text style={modalStyles.infoText}>
                        Ha csak egyet szeretnél kivenni a listából, szkenneld be
                        a konkrét eszközt újból.
                    </Text>
